      ...
      <div className="hidden lg:flex flex-col items-center justify-center bg-[#0a0a0a] relative overflow-hidden p-12 border-r border-white/5">
        ...
        <div className="relative z-10 flex flex-col items-center w-full max-w-lg">
          <img 
            src="/signup-png.png" 
            alt="SignUp Visual" 
            className="w-full h-auto object-contain drop-shadow-[0_0_80px_rgba(190,242,100,0.1)]"
          />
          <div className="text-center space-y-4 mt-12">
             <h2 className="text-5xl font-extrabold tracking-tighter leading-tight italic uppercase">
                Join the <br />
                <span className="text-[#bef264]">Revolution.</span>
             </h2>
             <p className="text-gray-500 font-medium text-lg max-w-xs mx-auto">Create your account and start chatting in seconds.</p>
          </div>
        </div>
      </div>
        ...
        <div className="w-full max-w-sm space-y-10 relative">
          ...
          <div className="text-center pt-4">
            <p className="text-gray-500">
              ...
              <Link to="/login" className="text-white font-bold hover:text-[#bef264] transition-colors border-b border-white hover:border-[#bef264]">
                Sign In
              </Link>
            </p>
          </div>
